          ...
          <div className="space-y-10">
            ...
            <div ref={buttonsRef} className="flex flex-col sm:flex-row gap-6">
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="animated-button px-10 py-4 text-lg bg-accent text-accent-foreground border-accent hover:shadow-lg hover:shadow-accent/25 transition-shadow duration-300 opacity-0"
