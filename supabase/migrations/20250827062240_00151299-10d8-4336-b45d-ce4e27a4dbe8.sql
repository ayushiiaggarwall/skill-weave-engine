...
-- Policies
CREATE POLICY IF NOT EXISTS "Anyone can view visible course weeks"
ON public.course_weeks
FOR SELECT
USING (visible = true);

CREATE POLICY IF NOT EXISTS "Admins can manage course weeks"
ON public.course_weeks
FOR ALL
...
DROP TRIGGER IF EXISTS update_course_weeks_updated_at ON public.course_weeks;
