          ...
          <div className="space-y-10">
            ...
            <div ref={buttonsRef} className="flex flex-col sm:flex-row gap-6">
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="animated-button px-10 py-4 text-lg glass-card border-primary/30 dark:text-primary light:text-black hover:bg-primary/10 hover:border-primary/50 hover:text-primary transition-all duration-300 opacity-0"
