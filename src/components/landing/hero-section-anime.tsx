        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-10">
            ...
            <div ref={buttonsRef} className="flex flex-col sm:flex-row gap-6">
              <Button 
                size="lg" 
                className="animated-button px-10 py-4 text-lg button-3d hover-glow relative overflow-hidden group opacity-0 bg-primary/90 text-primary-foreground hover:bg-primary"
